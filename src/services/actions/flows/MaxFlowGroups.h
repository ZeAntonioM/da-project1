...
public:
    ...
    /**
     * @brief Creates a Super Sink and connects it to all the stations of the municipality with a line with capacity INT16_MAX. Then it calculates the max flow and cost of the municipality and calls the draw() function so that the user can see the results.
     */
    void execute() override;
